...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"MapEnable", {PERSISTENT, BOOL, "0"}},
    {"MapSpeedLimit", {PERSISTENT, FLOAT}},
    {"OfflineMode", {PERSISTENT, BOOL, "1"}},
    {"OSMDownloadLocations", {CLEAR_ON_MANAGER_START, JSON}},
    {"OSMDownloadProgress", {CLEAR_ON_MANAGER_START, JSON}},
    {"OsmDbUpdatesCheck", {PERSISTENT, BOOL, "0"}},
    ...
    {"StartupCacheDone", {CLEAR_ON_MANAGER_START, BOOL, "0"}},
    ...
    {"BrightnessControl", {PERSISTENT, INT, "0"}},
    {"OnroadScreenOff", {PERSISTENT, INT, "-2"}},
    {"OnroadScreenOffBrightness", {PERSISTENT, INT, "50"}},
    {"OnroadScreenOffEvent", {PERSISTENT, BOOL, "1"}},
    ...
    {"CurveCenterOffset", {PERSISTENT, INT, "0"}},
